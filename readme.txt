...
Tags:   woocommerce, product, badge, custom-fields, woocommerce-custom-fields
...
== Description ==
<iframe width="560" height="315" src="https://www.youtube.com/embed/pEa15SWU8F8" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
<p><strong><a href="https://wpsaad.com/woocommerce-custom-product-type/" >Upgrade to premium Version.</a></strong></p>
...
<ul>
 	...
 	<li><a href="https://wpsaad.com/woocommerce-shipping-manager/">WooCommerce Shipping Manager</a></li>
</ul>

== Installation ==
<p>Just install the plugin on your WordPress website and then you will the product types tabs,
add yours and customize it throught the product types settings.</p>
...
<dd>This plugin Creates a fully customized product with awesome features that makes everything selable and well descriped through the product meta</dd>
<dt id="how"><h3><button formaction="#how">How to Use Custom Product type for WooCommerce?</button></h3></dt>
<dd>Just install and activate the plugin then you find the products types tab, Go there to create your first custom products type </dd>
</dl>


== Screenshots ==
1. Custom Product types settings and features
2. Custom Product types single product settings
3. Custom Product types admin settings 
